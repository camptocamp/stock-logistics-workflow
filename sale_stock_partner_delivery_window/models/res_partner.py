...
class ResPartner(models.Model):
    ...
    def _to_utc_naive(self, datetime_tz):
        """Convert a datetime back to naive UTC format.

        :param datetime_tz: timezone aware datetime.
        :return: naive UTC datetime.
        """
        return datetime_tz.astimezone(pytz.utc).replace(tzinfo=None)
    ...
    def _next_available_delivery_date(
        ...
        # or adjust accordingly
            ...
            return self._to_utc_naive(
                from_datetime_tz_aware + timedelta(days=7 - weekday)
            )
        ...
        # We use the tz-aware datetime, as windows are expressed in the partner's tz
            ...
            for days_to_add in range(7 + 1):
                ...
                for window in self.delivery_time_window_ids:
                    ...
                    return self._to_utc_naive(next_datetime)
